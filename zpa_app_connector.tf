...
resource "zpa_app_connector_group" "vODC" {
  name                     = var.zpa_app_connector_group
...
resource "zpa_provisioning_key" "vodc_provisioning_key" {
  ...
  zcomponent_id      = zpa_app_connector_group.vODC.id
}
